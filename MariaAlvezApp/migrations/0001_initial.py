...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='animal',
            name='tutor',
            field=models.ForeignKey(blank=True, help_text='Selecione o tutor responsável por este animal.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='animais_tutor', to='MariaAlvezApp.tutor', verbose_name='Tutor do Animal'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frequencia_respiratoria', models.IntegerField(blank=True, help_text='Frequência respiratória em respirações por minuto (RPM)', null=True)),
                ...
                ('exames_realizados', models.TextField(blank=True, help_text='Nomes ou IDs dos exames realizados (separados por vírgula)', null=True)),
                ...
                ('tutor', models.ForeignKey(blank=True, editable=False, help_text='Tutor do animal selecionado (preenchido automaticamente)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultas_clinicas', to='MariaAlvezApp.tutor', verbose_name='Tutor do Animal')),
                ('veterinario', models.ForeignKey(blank=True, help_text='Selecione o veterinário responsável pela consulta', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='consultas_realizadas', to='MariaAlvezApp.veterinario', verbose_name='Veterinário Responsável')),
            ],
            options={
